      ...
      <section className='about-me'>
        <div className='about-me__container container'>
          ...
          <article className='about-me__info'>
            ...
            <p className='about-me__text'>Живу в&nbsp;Санкт-Петербурге. В&nbsp;феврале 2023 года закончил курс &laquo;Веб-разработчик&raquo; в&nbsp;Яндекс Практикум. Ранее почти два года занимался вёрсткой сайтов для студии Zet Graphics. Открыт к&nbsp;предложениям о&nbsp;работе и&nbsp;сотрудничестве.</p>
